...
public class BookFlightActivity extends BaseActivity {
    ...
    MaterialSpinner teenager_spinner;
    MaterialSpinner childern_spinner;
    MaterialSpinner infants_spinner;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_book_a_flight);

        customToolbarTextView = setCustomToolbarTitle("Book a Flight");
    ...
    void setupAndInitializeViews() {
        ...
        teenager_spinner = (MaterialSpinner) findViewById(R.id.teenager_Spinner);
        teenager_spinner.setItems(values);
        childern_spinner = (MaterialSpinner) findViewById(R.id.children_Spinner);
        childern_spinner.setItems(values);

        infants_spinner = (MaterialSpinner) findViewById(R.id.infants_Spinner);
        infants_spinner.setItems(values);
    ...
    void showDate(final boolean isDepartureDate, int spinnerTheme) {
        ...
        new SpinnerDatePickerDialogBuilder()
                .context(BookFlightActivity.this)
